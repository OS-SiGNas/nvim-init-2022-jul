...
let s:lightblack  = { "gui": "#0c0c0c", "cterm": "235" }
...
let s:pink        = { "gui": "#ff89da", "cterm": "197" }
...
" editor
call s:h("Normal",        { "fg": s:changefg,      "bg": s:black })
call s:h("terminal_color_1",   { "fg": s:red,      "bg": s:black })
call s:h("ColorColumn",   {                     "bg": s:lightblack })
call s:h("CursorColumn",  {                     "bg": s:lightblack2 })
call s:h("CursorLine",    {                     "bg": s:darkblack })
call s:h("NonText",       { "fg": s:aqua})
...
call s:h("MatchParen",    { "fg": s:red,        "bg": s:lightblack2})
call s:h("Question",      { "fg": s:donatello})
call s:h("ModeMsg",       { "fg": s:black,        "bg": s:aqua})
...
" popup menu
call s:h("Pmenu",         { "fg": s:aqua,      "bg": s:popmenubg})
...
call s:h("Identifier",    { "fg": s:michelangelo, "format": "italic" })
call s:h("Function",      { "fg": s:scar, "format": "bold" })
                         
call s:h("Statement",     { "fg": s:addfg})
...
call s:h("NERDTreeDirSlash",        { "fg": s:red})
