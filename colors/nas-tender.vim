...
let g:colors_name="nas"


let Italic = ""
if exists('g:nas_italic')
  let Italic = "italic"
endif
let g:nas_italic = get(g:, 'nas_italic', 0)

let Bold = ""
if exists('g:nas_bold')
  let Bold = "bold"
endif

let g:nas_bold = get(g:, 'nas_bold', 0)
"airline
hi Folded guifg=#000000 ctermfg=242 guibg=#1d2026 ctermbg=234 gui=NONE cterm=NONE 
...
hi CursorLine guifg=NONE ctermfg=NONE guibg=#11161c ctermbg=236 gui=NONE cterm=NONE
hi CursorLineNr guifg=#ffffff ctermfg=81 guibg=#000000 ctermbg=NONE gui=Bold cterm=NONE
...
hi ErrorMsg guifg=#000000 ctermfg=203 guibg=#f43753 ctermbg=NONE gui=reverse cterm=reverse
hi VertSplit guifg=#000000 ctermfg=235 guibg=# ctermbg=235 gui=NONE cterm=NONE
hi FoldColumn guifg=#666666 ctermfg=242 guibg=#202020 ctermbg=234 gui=NONE cterm=NONE
hi SignColumn guifg=#999999 ctermfg=246 guibg=#NONE ctermbg=235 gui=NONE cterm=NONE
hi IncSearch guifg=#ffffff ctermfg=15 guibg=#000000 ctermbg=0 gui=Bold,reverse cterm=Bold,reverse
hi LineNr guifg=#4b84ff ctermfg=238 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi MatchParen guifg=#fff700 ctermfg=203 guibg=#000000 ctermbg=NONE gui=Bold cterm=Bold
...
hi Visual guifg=NONE ctermfg=NONE guibg=#333774 ctermbg=237 gui=none cterm=none
...
hi Comment guifg=#434c5b ctermfg=242 guibg=NONE ctermbg=NONE gui=italic cterm=NONE
...
hi String guifg=#ffae6c ctermfg=180 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi Identifier guifg=#ff0004 ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Function guifg=#fca1ff ctermfg=153 guibg=NONE ctermbg=NONE gui=Bold cterm=Bold
hi Statement guifg=#3c9aff ctermfg=153 guibg=NONE ctermbg=NONE gui=Bold cterm=Bold
...
hi Type guifg=#73cef4 ctermfg=81 guibg=NONE ctermbg=NONE gui=Bold cterm=NONE
hi Special guifg=#ff6bfd ctermfg=81 guibg=NONE ctermbg=NONE gui=bold cterm=NONE
...
hi typescriptArrowFunc guifg=#fbff00 ctermfg=215 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi typescriptFuncName guifg=#ff0000 ctermfg=185 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi typescriptObjectFuncName guifg=#ff0000 ctermfg=185 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi typescriptParens guifg=#f43753 ctermfg=153 guibg=NONE ctermbg=NONE gui=Bold cterm=Bold
hi javaScriptParens guifg=#f43753 ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi jsParens guifg=#f43753 ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi typescriptVariable guifg=#73cef4 ctermfg=81 guibg=NONE ctermbg=NONE gui=Bold cterm=NONE
...
hi typescriptIdentifierName guifg=#00ff00 ctermfg=255 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi typescriptObjectColon guifg=#ff0000 ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi typescriptBlock guifg=#62aeff ctermfg=203 guibg=NONE ctermbg=NONE gui=Bold cterm=NONE
